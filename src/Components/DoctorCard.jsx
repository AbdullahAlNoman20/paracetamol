...
const DoctorCard = ({doctor}) => {
    ...
    const {id,photo,name,specialist,cost,time,description} = doctor;
	...
	<div className="flex items-center justify-between p-3">
		<div className="flex items-center space-x-2">
			...
			<div className="-space-y-1">
				...
				<span className="inline-block text-xs leading-none dark:text-gray-600">{specialist}</span>
			</div>
		</div>
	...
	<div className="p-3">
		<div className="flex items-center justify-between">
			<div className="flex items-center space-x-3">
				<button type="button" title="Like This Doctor" className="flex items-center justify-center">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current">
			...
			<button type="button" title="Bookmark Doctor" className="flex items-center justify-center">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current">
		...
		<div className="flex flex-wrap items-center pt-3 pb-1">
			<div className="flex items-center space-x-2">
				...
				<span className="text-sm">Liked by
					<span className="font-semibold"> Abdullah </span>and
		...
		<div className="space-y-3">
			<p className="text-sm">
				<span className="text-base font-semibold">Cost: {cost}$ </span> Time: {time}
			</p>
			<input type="text" placeholder="Add a comment..." className="p-5 w-full py-0.5 dark:bg- border-none rounded text-sm pl-0 dark:text-gray-800" />
		</div>
	</div>
</div>
        </div>
